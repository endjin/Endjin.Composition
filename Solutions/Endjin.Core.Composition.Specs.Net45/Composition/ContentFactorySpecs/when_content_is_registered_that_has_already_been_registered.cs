namespace Endjin.Core.Specs.Composition.ContentFactorySpecs
{
    ...
    public class when_content_is_registered_that_has_already_been_registered : SpecificationsFor<TestContentFactory>
    {
        ...
        protected override void When()
        {
            try
            {
                this.SUT.RegisterContentFor<ExampleContent>(context.ContentName);
            }
            catch (Exception ex)
            {
                this.exception = ex;
        ...
        private content_is_registered context;
    }
}